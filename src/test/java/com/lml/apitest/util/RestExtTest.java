...
public class RestExtTest {
    ...
    public void getTest() {
        ...
        // 参数直接在url上
        reqUrl = URL + "/get?name=" + reqUserDto.getName();
    ...
    public void deleteTest() {
        ...
        Assert.assertEquals(reqUserDto.getName(), URLUtil.decode(vo.getStr("data")));
